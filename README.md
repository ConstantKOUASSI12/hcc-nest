...
internet et un application mobile pour promouvoir ses activités, avec un l d'actualités et un
...
1. **Cloner le dépôt :**
-  git clone (https://github.com/ConstantKOUASSI12/hcc-nest)
-  cd hcc-nest
...
4. **Lancer le Swagger UI route :**
-  http://localhost:3000/api-docs

5. **Credentials des utilisateurs de test**
##
   - email : kouassiconstant94@gmail.com
   - password : 1234567890
   - profile : ADMIN
---
   - email : jean13@liveee.fr
   - password : 1234567890
   - profile : COACH
---
   - email : jean13@live.fr
   - password : 1234567890
   - profile : CONTRIBUTOR
---
   - email : jean13@livee.fr
   - password : 1234567890
   - profile : PLAYER
